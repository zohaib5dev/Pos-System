...
class Adjustments extends Component
{
    ...
    public function getAdjustmentsQuery()
    {
        return StockAdjustment::with(['product', 'creator'])
            ...
            ->when($this->dateRange !== 'all', function ($query) {
                switch ($this->dateRange) {
                    ...
                    case 'custom':
                        return $query->whereBetween('created_at', [$this->startDate, $this->endDate . ' 23:59:59']);
                }
            });
    }
    ...
    public function render()
    {
        ...
        return view('livewire.inventories.adjustments', [
